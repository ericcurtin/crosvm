...
// Windows and macOS because the concept of jailing is baked into a bunch of places where it isn't
// easy to compile it out. In the long term, this should go away.
